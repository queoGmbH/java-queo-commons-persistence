...
public class BusinessEntityModule extends Module {
     ...
     */
    static class BusinessEntityKeySerializer<T extends BusinessEntity<T>> extends JsonSerializer<T> {
         ...
         */
        @Override
        public void serialize(final T entity, final JsonGenerator jgen, final SerializerProvider provider)
                throws IOException, JsonProcessingException {
