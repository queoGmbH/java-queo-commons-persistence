...
public class SwitchingBusinessEntityModule extends Module {
     ...
     * @param if true, then the {@link BusinessIdModule} become enabled too
     * @param if true, then the fields id, hibernateId, businessIdValue and isNew are omitted from ALL
    ...
    public void setupModule(final SetupContext context) {
        ...
        if (enableBusinessIdModule) {
            new BusinessIdModule().setupModule(context);
        }

        if (omitBusinessEnitityIds) {
